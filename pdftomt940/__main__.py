...
from . import PdfExtractionError, build_mt940, extract_text_lines, parse_statement_text
...
def main() -> None:
    ...
    try:
        lines = extract_text_lines(args.statement)
        statement = parse_statement_text(lines)
        mt940_payload = build_mt940(statement)
